  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<%=baseUrl%>/views/applyclassroommanage/applyclassroommanage.jsp">教室申请管理</a></li>
        <li><a href="<%=baseUrl%>/views/timetablemanage/timetablestatemanage.jsp">教室状态管理</a></li>
        <%--<li>
