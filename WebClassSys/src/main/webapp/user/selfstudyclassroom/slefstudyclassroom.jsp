    ...
    <div class="row">
      <div class="col-sm-12">
        <form class="form-inline" style="margin-bottom: 10px" role="form">
          ...
          &nbsp;&nbsp;&nbsp;
          <div class="form-group">
            <input class="form-control" id="search_calssname" name="classRoomName" title="座位数大于..." placeholder="教室名称" >
          </div>
          &nbsp;&nbsp;&nbsp;
...
<script>
  seajs.use(basePath + "/user/selfstudyclassroom/js/slefstudyclassroom", function (data) {
    data.initEvent();
  });//这里是调用初始化函数，进行初始化工作
</script>
